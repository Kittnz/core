...
replace into `mangos_string` (`entry`, `content_default`) values ('50006', 'Turtle WoW: Please remember, a GM will never ask for your password, so please do NOT share your password with anyone. Use a secure password, and change it often. Protect your account!');
replace into `mangos_string` (`entry`, `content_default`) values ('50007', 'Turtle WoW: Donations are a way to help us improve your experience here at Turtle WoW, as well as help pay for general server costs, advertisement campaigns, developers, and overall production. You can find changelogs and videos on our website and social media platforms. Thanks for your continued support!');
...
replace into `mangos_string` (`entry`, `content_default`) values ('50010', 'Turtle WoW: Speak with Karn Deepeye in Orgrimmar or Tarun Swifteagle in Stormwind in order to become diplomats! You will be able to group, trade and speak with members of the other faction!');
...
replace into `autobroadcast` (`string_Id`) values ('50002');
replace into `autobroadcast` (`string_Id`) values ('50003');
replace into `autobroadcast` (`string_Id`) values ('50004');
replace into `autobroadcast` (`string_Id`) values ('50005');
replace into `autobroadcast` (`string_Id`) values ('50006');
replace into `autobroadcast` (`string_Id`) values ('50007');
