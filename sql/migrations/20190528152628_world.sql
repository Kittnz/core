...
update item_template set buy_price = 50000, sell_price = 12500, required_reputation_faction = 0, required_reputation_rank = 0, script_name = 'bg_tabard', spellid_1 = 26489, description = 'Fight for the Arathi Basin! Use it to join the battle.' where entry in (20131, 20132);
update item_template set buy_price = 100000, sell_price = 25000, required_reputation_faction = 0, required_reputation_rank = 0, script_name = 'bg_tabard', spellid_1 = 26489, description = 'Fight for the Alterac Valleu! Use it to join the battle.' where entry in (19031, 19032);
