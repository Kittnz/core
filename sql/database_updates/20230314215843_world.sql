...
UPDATE creature SET spawntimesecsmin = 120,spanwtimesecsmax = 120 WHERE guid IN (44988, 44990, 45020, 44611, 44617, 44626, 45038, 44581, 44766, 44739, 2569248, 44786, 15080);
UPDATE creature SET spawntimesecsmin = 120,spanwtimesecsmax = 120 WHERE id IN (1535, 1536, 1537, 1538, 1539, 1540, 1660, 1941, 1674, 1675);
UPDATE gameobject SET spawntimesecsmin = 30,spanwtimesecsmax = 30 WHERE guid IN (180226, 180227);