UPDATE quest_template SET ZoneOrSort = 5179 WHERE entry = 40974;
...
update item_template set delay = 1700, dmg_min1 = 54, dmg_max1 = 100 where entry = 61001; -- Claw of the Infinite
update item_template set max_amount = 1, spelltrigger_4 = 1 where entry = 61205; -- Ring of Nature's Duality
