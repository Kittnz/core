...
-- Remove custom mechanic type from spells that I added some years ago to handle bosses being immune to effects that slow their casting speed. We no longer require a mechanic to define the immunity.
