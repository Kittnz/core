...
REPLACE INTO `broadcast_text` (`entry`, `male_text`, `female_text`, `chat_type`, `sound_id`, `language_id`, `emote_id1`, `emote_id2`, `emote_id3`, `emote_delay1`, `emote_delay2`, `emote_delay3`) VALUES (47030, 'You there, I see you have brought yourself to Shell Co. Trading Company!\n\nA new currency has reached our ears in Orgrimmar, one that is taking the humans by storm. It is a magical coin that will change Azeroth forever. It is time to invest your spoils, young one.\n\nLook at me, I was once a pathetic druid, nothing to my name, and now I am one of the biggest shareholders of Shellcoin. Invest early, and you\'ll become richer than you can imagine.', '', 0, 0, 0, 0, 0, 0, 0, 0, 0);
