...
DELETE FROM creature WHERE guid=2579335;
DELETE FROM creature_addon WHERE guid=2579335;
DELETE FROM creature_movement WHERE id=2579335;
DELETE FROM game_event_creature WHERE guid=2579335;
