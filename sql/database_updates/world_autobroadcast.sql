...
(50001, 'Until June 25th, all donation rewards are available at half the price. This sale marks the last opportunity to purchase items at this discounted rate, from there on, we will conduct smaller sales for categories and add token bonuses.'),
