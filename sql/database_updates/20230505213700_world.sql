...
DELETE FROM creature WHERE guid=2555551;
DELETE FROM creature_addon WHERE guid=2555551;
DELETE FROM creature_movement WHERE id=2555551;
DELETE FROM game_event_creature WHERE guid=2555551;
DELETE FROM game_event_creature_data WHERE guid=2555551;
DELETE FROM creature_battleground WHERE guid=2555551;
