...
(6,  1, 50603, 0, 0, 'Change Race: Human', 'Placeholder', 350, 0, 0, 0, 0, 0, 1),
(7,  1, 50604, 0, 0, 'Change Race: Gnome', 'Placeholder', 350, 0, 0, 0, 0, 0, 1),
(8,  1, 50605, 0, 0, 'Change Race: Dwarf', 'Placeholder', 350, 0, 0, 0, 0, 0, 1),
(9,  1, 50606, 0, 0, 'Change Race: Night Elf', 'Placeholder', 35, 0, 0, 0, 0, 0, 1),
(10, 1, 50607, 0, 0, 'Change Race: Orc', 'Placeholder', 350, 0, 0, 0, 0, 0, 1),
(11, 1, 50608, 0, 0, 'Change Race: Troll', 'Placeholder', 350, 0, 0, 0, 0, 0, 1),
(12, 1, 50609, 0, 0, 'Change Race: Tauren', 'Placeholder', 350, 0, 0, 0, 0, 0, 1),
(13, 1, 50610, 0, 0, 'Change Race: Undead', 'Placeholder', 350, 0, 0, 0, 0, 0, 1),
(14, 1, 50613, 0, 0, 'Change Race: Goblin', 'Placeholder', 350, 0, 0, 0, 0, 0, 1),
(15, 1, 50612, 0, 0, 'Change Race: High Elf', 'Placeholder', 350, 0, 0, 0, 0, 0, 1),
...
(101, 5, 50071, 4807, 0, 'Ivory Tallstrider', '象牙陆行鸟', 100, 0, 0, 0, 0, 0, 1),
(102, 5, 50072, 6474, 0, 'Brown Tallstrider', '棕色陆行鸟', 100, 0, 0, 0, 0, 0, 1),
(103, 5, 50073, 6475, 0, 'Gray Tallstrider', '灰色陆行鸟', 100, 0, 0, 0, 0, 0, 1),
(104, 5, 50076, 6478, 0, 'Turquoise Tallstrider', '绿松石陆行鸟', 100, 0, 0, 0, 0, 0, 1),
(105, 5, 50074, 6476, 0, 'Pink Tallstrider', '粉红高陆行鸟', 100, 0, 0, 0, 0, 0, 1),
(106, 5, 81100, 18180, 0, 'Swift Raven Lord', '迅捷乌鸦领主', 500, 0, 0, 0, 0, 0, 1),
(107, 5, 81120, 18295, 0, 'Frayfeather Hippogryph', '乱羽角鹰兽', 500, 0, 0, 0, 0, 0, 1),
(108, 5, 81121, 18299, 0, 'Cenarion Hippogryph', '塞纳里奥角鹰兽', 500, 0, 0, 0, 0, 0, 1),
(109, 5, 81242, 18298, 0, 'Viridian Hippogryph', '翠绿角鹰兽', 300, 0, 0, 0, 0, 0, 1),
(110, 5, 80431, 18094, 0, 'Swift Magic Rooster', '迅捷魔法公鸡', 300, 0, 0, 0, 0, 0, 1),
(121, 5, 12325, 4805, 0, 'Spotted Leopard', '斑点刃豹', 200, 0, 0, 0, 0, 0, 1),
(122, 5, 12326, 6442, 0, 'Tawny Leopard', '褐色刃豹', 200, 0, 0, 0, 0, 0, 1),
(123, 5, 12327, 9714, 0, 'Golden Leopard', '黄金刃豹', 200, 0, 0, 0, 0, 0, 1),
(124, 5, 8630, 6443, 0, 'Stranglethorn Tiger', '荆棘谷老虎', 200, 0, 0, 0, 0, 0, 1),
(125, 5, 81227, 18255, 0, 'Striped Dawnsaber', '虎纹黎明刃豹', 200, 0, 0, 0, 0, 0, 1),
(126, 5, 12302, 9695, 0, 'Ancient Frostsaber', '远古霜刃剑', 200, 0, 0, 0, 0, 0, 1),
(127, 5, 8635, 9991, 0, 'Ancient Nightsaber', '远古夜刃豹', 200, 0, 0, 0, 0, 0, 1),
(128, 5, 81232, 18435, 0, 'Azure Frostsaber', '蔚蓝霜刃剑', 160, 0, 0, 0, 0, 0, 1),
(129, 5, 18768, 14329, 0, 'Armored Dawnsaber', '装甲黎明刃豹', 260, 0, 0, 0, 0, 0, 1),
(130, 5, 80430, 18143, 0, 'Armored Spectral Tiger', '装甲幽灵虎', 2000, 0, 0, 0, 0, 0, 1),
(131, 5, 12303, 9991, 0, 'Black Zulian Panther', '黑色祖利安刃豹', 200, 0, 0, 0, 0, 0, 1),
(132, 5, 81231, 18436, 0, 'Tamed Rak\'Shiri', '驯服的拉克希里', 200, 0, 0, 0, 0, 0, 1),
(141, 5, 50399, 2186, 0, 'Ancient Quel\'dorei Steed', '上古奎尔多雷战马', 200, 0, 0, 0, 0, 0, 1),
(142, 5, 80449, 18259, 0, 'Armored Alliance Steed', '装甲联盟战马', 300, 0, 0, 0, 0, 0, 1),
(143, 5, 81236, 18260, 0, 'Armored Gray Steed', '装甲灰骏马', 200, 0, 0, 0, 0, 0, 1),
(144, 5, 23193, 10718, 0, 'Armored Black Deathcharger', '装甲黑色死亡战马', 300, 0, 0, 0, 0, 0, 1),
(145, 5, 81235, 18262, 0, 'Armored Vermilion Deathcharger', '装甲绯红死亡战马', 300, 0, 0, 0, 0, 0, 1),
(146, 5, 50407, 2185, 0, 'Nightmare Dreamrunner', '噩梦行者', 200, 0, 0, 0, 0, 0, 1),
(147, 5, 50400, 18243, 0, 'Riding Zhevra', '骑乘斑纹斑马', 200, 0, 0, 0, 0, 0, 1),
(148, 5, 81234, 18252, 0, 'Brewfest Ram', '美酒节公羊', 200, 0, 0, 0, 0, 0, 1),
(149, 5, 80443, 18253, 0, 'Armored Brewfest Ram', '装甲美酒节公羊', 360, 0, 0, 0, 0, 0, 1),
(150, 5, 13328, 2784, 0, 'Ancient Black Ram', '远古黑色公羊', 200, 0, 0, 0, 0, 0, 1),
(151, 5, 50406, 19101, 0, 'Shadowhorn Stag', '暗角雄鹿', 200, 0, 0, 0, 0, 0, 1),
(162, 5, 80455, 18265, 0, 'Armored Brewfest Kodo', '装甲美酒节科多兽', 400, 0, 0, 0, 0, 0, 1),
(163, 5, 1041, 207, 0, 'Ancient Black Wolf', '远古黑色巨狼', 200, 0, 0, 0, 0, 0, 1),
(164, 5, 5663, 2326, 0, 'Ancient Red Wolf', '远古红色巨狼', 200, 0, 0, 0, 0, 0, 1),
(165, 5, 80447, 18257, 0, 'Armored Horde Wolf', '装甲部落战狼', 300, 0, 0, 0, 0, 0, 1),
(181, 5, 50401, 14345, 0, 'Armored Ivory Raptor', '装甲象牙迅猛龙', 360, 0, 0, 0, 0, 0, 1),
(182, 5, 50402, 14343, 0, 'Armored Violet Raptor', '装甲紫罗兰迅猛龙', 360, 0, 0, 0, 0, 0, 1),
(183, 5, 50403, 14341, 0, 'Armored Red Raptor', '装甲红色迅猛龙', 360, 0, 0, 0, 0, 0, 1),
(184, 5, 50404, 14340, 0, 'Armored Obsidian Raptor', '装甲黑曜石迅猛龙', 360, 0, 0, 0, 0, 0, 1),
(185, 5, 81154, 18481, 0, 'Armored Black Bear', '装甲黑色战熊', 400, 0, 0, 0, 0, 0, 1),
(186, 5, 81153, 18488, 0, 'Armored Purple Bear', '装甲紫色战熊', 400, 0, 0, 0, 0, 0, 1),
(187, 5, 81155, 18484, 0, 'Armored Red Bear', '装甲红色战熊', 400, 0, 0, 0, 0, 0, 1),
(188, 5, 81158, 18491, 0, 'Armored Frostmane Bear', '装甲霜鬃战熊', 400, 0, 0, 0, 0, 0, 1),
(189, 5, 81091, 18492, 0, 'Big Blizzard Bear', '暴雪大战熊', 500, 0, 0, 0, 0, 0, 1),
(190, 5, 81102, 18090, 0, 'Darkmoon Dancing Bear', '暗月跳舞熊', 300, 0, 0, 0, 0, 0, 1),
(225, 5, 83150, 20416, 0, 'Big Turtle WoW Bear', '巨龟战熊', 360, 0, 0, 0, 0, 0, 1),
(226, 5, 83151, 20417, 0, 'Black Spectral Tiger', '黑色幽灵虎', 2000, 0, 0, 0, 0, 0, 1),
(227, 5, 83152, 20419, 0, 'Green Spectral Tiger', '绿色幽灵虎', 2000, 0, 0, 0, 0, 0, 1),
(228, 5, 83154, 20421, 0, 'Armored Ice Raptor', '装甲冰霜迅猛龙', 360, 0, 0, 0, 0, 0, 1),
(229, 5, 83155, 20422, 0, 'Scarlet Charger', '猩红战马', 360, 0, 0, 0, 0, 0, 1),
(230, 5, 83158, 20425, 0, 'Brown Zhevra', '棕色斑马', 360, 0, 0, 0, 0, 0, 1),
(231, 5, 50536, 19170, 0, 'Twilight', '恐怖图腾科多兽', 1000, 0, 0, 0, 0, 0, 1),
...
(314, 8, 92041, 18778, 0, 'Illusion: Incubus', 'PLACEHOLDER', 160, 0, 0, 0, 0, 0, 1),
