...
(101, 5, 50071, 4807, 0, 'Ivory Tallstrider', '象牙陆行鸟', 100, 0, 2, 0, 0.1, -0.25, 1),
(102, 5, 50072, 6474, 0, 'Brown Tallstrider', '棕色陆行鸟', 100, 0, 2, 0, 0.1, -0.2, 1),
(103, 5, 50073, 6475, 0, 'Gray Tallstrider', '灰色陆行鸟', 100, 0, 2, 0, 0.1, -0.2, 1),
...
(107, 5, 81120, 18295, 0, 'Frayfeather Hippogryph', '乱羽角鹰兽', 500, 0, 1, 0.1, 0.5, -0.2, 1),
(108, 5, 81121, 18299, 0, 'Cenarion Hippogryph', '塞纳里奥角鹰兽', 500, 0, 1, 0.1, 0.5, -0.2, 1),
(109, 5, 81242, 18298, 0, 'Viridian Hippogryph', '翠绿角鹰兽', 300, 0, 1, 0.1, 0.5, -0.2, 1),
(110, 5, 80431, 18094, 0, 'Swift Magic Rooster', '迅捷魔法公鸡', 300, 0, -0.8, 0, -0.6, -0.2, 1),
(121, 5, 12325, 4805, 0, 'Spotted Leopard', '斑点刃豹', 200, 0, 1, 0.2, 1.2, -0.4, 1),
(122, 5, 12326, 6442, 0, 'Tawny Leopard', '褐色刃豹', 200, 0, 1, 0.2, 1.2, -0.3, 1),
...
(126, 5, 12302, 9695, 0, 'Ancient Frostsaber', '远古霜刃剑', 200, 0, 1, 0.2, 1.1, -0.2, 1),
(127, 5, 8635, 9991, 0, 'Ancient Nightsaber', '远古夜刃豹', 200, 0, 1, 0.2, 1.2, -0.3, 1),
(128, 5, 81232, 18435, 0, 'Azure Frostsaber', '蔚蓝霜刃剑', 160, 0, 1, 0.2, 1.2, -0.3, 1),
...
(132, 5, 81231, 18436, 0, 'Tamed Rak\'Shiri', '驯服的拉克希里', 200, 0, 1, 0.2, 1.2, -0.4, 1),
...
(143, 5, 81236, 18260, 0, 'Armored Gray Steed', '装甲灰骏马', 200, 0, -2.2, -1.1, 1, -0.1, 1),
(144, 5, 23193, 10718, 0, 'Armored Black Deathcharger', '装甲黑色死亡战马', 300, 0, -1.6, 0, -0.7, -0.2, 1),
(145, 5, 81235, 18262, 0, 'Armored Vermilion Deathcharger', '装甲绯红死亡战马', 300, 0, -1.6, 0.1, -0.8, -0.2, 1),
(146, 5, 50407, 2185, 0, 'Nightmare Dreamrunner', '噩梦行者', 200, 0, -0.2, 0, -0.3, -0.2, 1),
(147, 5, 50400, 18243, 0, 'Riding Zhevra', '骑乘斑纹斑马', 200, 0, -1, -2.8, -0.1, 0.6, 1),
(148, 5, 81234, 18252, 0, 'Brewfest Ram', '美酒节公羊', 200, 0, -2, -1.33, 1.2, -0.2, 1),
(149, 5, 80443, 18253, 0, 'Armored Brewfest Ram', '装甲美酒节公羊', 360, 0, -1.5, -0.8, 1.55, -0.2, 1),
(150, 5, 13328, 2784, 0, 'Ancient Black Ram', '远古黑色公羊', 200, 0, -2, -1.25, 1.2, -0.2, 1),
(151, 5, 50406, 19101, 0, 'Shadowhorn Stag', '暗角雄鹿', 200, 0, -3, 0.3, 0.5, -0.6, 1),
(162, 5, 80455, 18265, 0, 'Armored Brewfest Kodo', '装甲美酒节科多兽', 400, 0, -10, 0, -0.2, -0.2, 1),
(163, 5, 1041, 207, 0, 'Ancient Black Wolf', '远古黑色巨狼', 200, 0, 0, -0.15, 0.3, -0.15, 1),
(164, 5, 5663, 2326, 0, 'Ancient Red Wolf', '远古红色巨狼', 200, 0, 0, -0.15, 0.3, -0.2, 1),
(165, 5, 80447, 18257, 0, 'Armored Horde Wolf', '装甲部落战狼', 300, 0, 0, -0.15, 0.25, -0.2, 1),
(181, 5, 50401, 14345, 0, 'Armored Ivory Raptor', '装甲象牙迅猛龙', 360, 0, -3.8, 0.38, 1.2, -0.2, 1),
(182, 5, 50402, 14343, 0, 'Armored Violet Raptor', '装甲紫罗兰迅猛龙', 360, 0, -3.8, 0.38, 1.1, -0.2, 1),
(183, 5, 50403, 14341, 0, 'Armored Red Raptor', '装甲红色迅猛龙', 360, 0, -3.8, 0.38, 1.2, -0.2, 1),
(184, 5, 50404, 14340, 0, 'Armored Obsidian Raptor', '装甲黑曜石迅猛龙', 360, 0, -3.8, 0.38, 1.1, -0.2, 1),
(185, 5, 81154, 18481, 0, 'Armored Black Bear', '装甲黑色战熊', 400, 0, -1, 0.1, -0.5, -0.2, 1),
(186, 5, 81153, 18488, 0, 'Armored Purple Bear', '装甲紫色战熊', 400, 0, -1, 0, -0.6, -0.3, 1),
...
(190, 5, 81102, 18090, 0, 'Darkmoon Dancing Bear', '暗月跳舞熊', 300, 0, -1, 0, -0.4, -0.3, 1),
...
(230, 5, 83158, 20425, 0, 'Brown Zhevra', '棕色斑马', 360, 0, -1, -2.8, 0, 0.5, 1),
(231, 5, 50536, 19170, 0, 'Twilight', '恐怖图腾科多兽', 1000, 0, -0.4, 0.3, -0.6, -0.6, 1),
