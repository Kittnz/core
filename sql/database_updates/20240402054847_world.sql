...
UPDATE quest_template SET RequiredRaces = 4 WHERE entry IN (6074, 6064, 6084, 6085, 6086);
UPDATE quest_template SET RequiredRaces = 4 WHERE entry IN (6064, 6084, 6085, 6086);
