...
-- maraudon changes
update item_template set disenchant_id = 47, durability = 30, armor = 41, sell_price = 6151, buy_price = 30755, spellid_1 = 9342, spelltrigger_1 = 1 where entry = 17750; -- Chloromesh Girdle
update item_template set disenchant_id = 47, durability = 75, armor = 130, sell_price = 15344, buy_price = 76720, stat_value1 = 17, stat_value2 = 16 where entry = 17751; -- Brusslehide Leggings
