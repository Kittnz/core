...
update skill_line_ability set req_train_points = 13 where entry = 13401; -- Thunderstomp (Rank 1)
update skill_line_ability set req_train_points = 17 where entry = 13411; -- Thunderstomp (Rank 2)
update skill_line_ability set req_train_points = 21 where entry = 13412; -- Thunderstomp (Rank 3)
update skill_line_ability set req_train_points = 25 where entry = 36565; -- Thunderstomp (Rank 4) - 1009 for serpent, 1010 for fox
update skill_line_ability set skill_id = 1009 where entry = 36562; -- Poison Spit (Rank 1)
update skill_line_ability set skill_id = 1009 where entry = 36563; -- Poison Spit (Rank 2)
update skill_line_ability set skill_id = 1009 where entry = 36564; -- Poison Spit (Rank 3)
