...
REPLACE INTO `creature` VALUES (2580093,61657,0,0,0,1,136.909,-7847.12,77.5177,1.2458,300,300,8,100,100,1,0,0);
REPLACE INTO `creature` VALUES (2580094,61674,0,0,0,1,83.2109,-7823.04,56.2921,5.99823,120,120,0,100,100,0,0,0);
REPLACE INTO `creature` VALUES (2580094,61674,0,0,0,1,83.2109,-7823.04,56.2921,5.99823,300,300,8,100,100,1,0,0);
DELETE FROM creature WHERE guid=2579350;
DELETE FROM creature_addon WHERE guid=2579350;
DELETE FROM creature_movement WHERE id=2579350;
DELETE FROM game_event_creature WHERE guid=2579350;
DELETE FROM game_event_creature_data WHERE guid=2579350;
DELETE FROM creature_battleground WHERE guid=2579350;
