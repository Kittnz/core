...
replace into creature (id, map, position_x, position_y, position_z, orientation, spawntimesecsmin, spawntimesecsmax, wander_distance, health_percent, movement_type, patch_max) values (60408,1,660.841919,-3322.699463,212.923172,3.14,300,300,3,20,0,10);
...
Quest NPC (End): Logrash

Additional notes: For additional information on the quest location check out the PDF on the channel ostarius-of-uldum
