...
replace into `mangos_string` (`entry`, `content_default`) values ('50004', 'Turtle WoW: Greetings Tortollans! Want to find players to start a RP adventure? Looking for a fun guild to join? Keep up to date with the Turtle WoW community and join our Discord channel: https://discord.gg/mBGxmHy');
