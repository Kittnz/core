...
delete from `broadcast_text` where `ID` = 90100;
...
delete from `npc_text` where `ID` = 90100;
insert into `npc_text` (`ID`, `BroadcastTextID0`) values ('90100', '90100');

delete from `broadcast_text` where `ID` = 90101;
insert into `broadcast_text` (`ID`, `MaleText`) values

('90101', 'Transport to the battlefield is on its way! Slow and steady wins the race. Stand by!');

delete from `npc_text` where `ID` = 90101;
insert into `npc_text` (`ID`, `BroadcastTextID0`) values ('90101', '90101');
