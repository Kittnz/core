...
('50002', 'Keep up to date with the Turtle WoW community and join our Discord channel: |cff0ccaecdiscord.turtle-wow.org|r'),
('50003', 'Type |cff0ccaec/join world|r now to connect with the community around you, and find friends for groups, dungeons, and trades! Please |cff0ccaec/join horde|r or |cff0ccaec/join alliance|r for faction-only talks.'),
...
('50005', 'Donations are a way to help us improve your experience here at Turtle WoW, as well as help pay for general server costs. Check our shop for donation rewards if you are interested to contribute to this community: |cff0ccaecturtle-wow.org/donate|r'),
...
('50010', 'We\'ve implemented a list of features that Blizzard never published, you can find information about them on our forums under |cff0ccaecSands of Time|r section.'),
...
('50012', 'We\'re constantly working on improving the leveling experience on Turtle WoW: creating new quests for starting locations or extending the existing quest chains. If you have an idea for a new quest, please visit this page: |cff0ccaecdev.turtle-wow.org|r');
