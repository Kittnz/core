...
replace into creature_questrelation (id, quest, patch_min, patch_max) values (@questgiver_id, @quest_entry,'10','10'); -- NPC 80000 doesn't exist yet. 15004 DID High Elf Ranger
