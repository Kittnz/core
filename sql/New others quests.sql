...
delete from creature where id = 91415 and position_x between -1007.330 and -1007.320;
replace into creature (id, map, position_x, position_y, position_z, orientation, spawntimesecsmin, spawntimesecsmax, wander_distance, health_percent, movement_type, patch_max) values (91415,0,-1007.324,-3555.890,56.890,6.04,300,300,3,100,0,10);
