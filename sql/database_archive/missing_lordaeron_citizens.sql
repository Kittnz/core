...
UPDATE `creature_template` SET `faction` = 7, `speed_walk`=1.11111, `speed_run`=1.14286, `base_attack_time`=2000 WHERE `entry` = 3617;
REPLACE INTO `creature` (`guid`, `id`, `map`, `position_x`, `position_y`, `position_z`, `orientation`, `wander_distance`, `movement_type`, `spawntimesecsmin`, `spawntimesecsmax`) VALUES 
...
REPLACE INTO `creature_template_addon` (entry, auras) VALUES (3617, 4986); 