        ...
        if (m_uiUpdateTimer < uiDiff)
        {
            ...
            for (Player* player : players)
            {
                if (!player->IsInCombat())
                {
                    ...
                    {{
                        { 181580, WorldLocation{800, -11068.1F, -1806.4F, 52.7F, 1.5F} },
                        { 181581, WorldLocation{0, -11068.9F, -1828.6F, 60.26F, 3.1F} },
                        { 112911, WorldLocation{802, 579.13F, 90.70F, 276.11F, 3.4F} },
                        { 112912, WorldLocation{1, 1722.0F, -1272.6F, 163.26F, 5.8F} },
                        { 112915, WorldLocation{269, -2002.5F, 6575.3F, -154.9F, 5.7F} },
                        { 112916, WorldLocation{1, -8756.8F, -4191.3F, -209.4F, 5.5F} },
                        { 112917, WorldLocation{35, -1.15F, 44.4F, -25.58F, 1.6F} },
                        { 112918, WorldLocation{0, -8677.6F, 637.0F, 96.9F, 5.3F} },
                    }};
