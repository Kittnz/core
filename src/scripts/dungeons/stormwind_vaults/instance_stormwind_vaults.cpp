...
struct boss_volkan_cruelbladeAI : public ScriptedAI
{
    boss_volkan_cruelbladeAI(Creature* c) : ScriptedAI(c)
    {
        ...
        m_data = {
            ...
            {SPELL_BLOODLUST, {m_holder.GetNextStep(SPELL_BLOODLUST), 40.f, InteractType::Yell, TargetSpell::Me, "I will see you fall! Trk�hsk!"}},
            {SPELL_BLOODLUST, {m_holder.GetNextStep(SPELL_BLOODLUST), 10.f, InteractType::Yell, TargetSpell::Me, "Lok�tar Ogar!"}},
