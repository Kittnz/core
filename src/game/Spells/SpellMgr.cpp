...
SpellCastResult SpellMgr::GetSpellAllowedInLocationError(SpellEntry const *spellInfo, Unit const* caster, Player const* player)
{
    ...
    switch (spellInfo->Id)
    {
        ...
        {
            return player && (player->InBattleGround() || player->InGurubashiArena(true)) ? SPELL_CAST_OK : SPELL_FAILED_ONLY_BATTLEGROUNDS;
        }
        case 22011:                                         // Spirit Heal Channel
        case 22012:                                         // Spirit Heal
        case 24171:                                         // Resurrection Impact Visual
        {   /* Remove SPELL_CAST_OK if you return this check. Required for Turtlw WoW Arena Tournament.
