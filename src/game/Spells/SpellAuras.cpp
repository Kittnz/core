...
void Aura::HandleAuraModAttackPower(bool apply, bool /*Real*/)
{
    ...
    if (!apply && GetId() == 23234)
    {
        int32 attackPower = -25 * (GetTarget()->GetInt32Value(UNIT_FIELD_ATTACK_POWER)) / 100;
        if (attackPower < 0)
            GetTarget()->CastCustomSpell(GetTarget(), 23230, &attackPower, nullptr, nullptr, true, nullptr, this);
    }
#endif
}
