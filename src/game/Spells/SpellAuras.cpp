...
void SpellAuraHolder::SetAffectedByVisibleSlotLimit(bool isAffectedByVisibleSlotLimit)
{
    m_visibleSlotLimitAffected = isAffectedByVisibleSlotLimit;
}
...
void SpellAuraHolder::CalculateForDebuffLimit()
{
    ...
    else if (m_spellProto->IsChanneledSpell() && m_visibleSlotLimitScore < 1)
        m_visibleSlotLimitScore = 1;
}
