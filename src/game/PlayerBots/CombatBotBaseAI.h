...
public:
    ...
    virtual bool ShouldIgnoreCombat() = 0;

    virtual void UpdateInCombatAI_Paladin_Pve() = 0;
    virtual void UpdateOutOfCombatAI_Paladin_Pve() = 0;
    virtual void UpdateInCombatAI_Shaman_Pve() = 0;
    virtual void UpdateOutOfCombatAI_Shaman_Pve() = 0;
    virtual void UpdateInCombatAI_Hunter_Pve() = 0;
    virtual void UpdateOutOfCombatAI_Hunter_Pve() = 0;
    virtual void UpdateInCombatAI_Mage_Pve() = 0;
    virtual void UpdateOutOfCombatAI_Mage_Pve() = 0;
    virtual void UpdateInCombatAI_Priest_Pve() = 0;
    virtual void UpdateOutOfCombatAI_Priest_Pve() = 0;
    virtual void UpdateInCombatAI_Warlock_Pve() = 0;
    virtual void UpdateOutOfCombatAI_Warlock_Pve() = 0;
    virtual void UpdateInCombatAI_Warrior_Pve() = 0;
    virtual void UpdateOutOfCombatAI_Warrior_Pve() = 0;
    virtual void UpdateInCombatAI_Rogue_Pve() = 0;
    virtual void UpdateOutOfCombatAI_Rogue_Pve() = 0;
    virtual void UpdateInCombatAI_Druid_Pve() = 0;
    virtual void UpdateOutOfCombatAI_Druid_Pve() = 0;

    virtual void UpdateInCombatAI_Paladin_Pvp() = 0;
    virtual void UpdateOutOfCombatAI_Paladin_Pvp() = 0;
    virtual void UpdateInCombatAI_Shaman_Pvp() = 0;
    virtual void UpdateOutOfCombatAI_Shaman_Pvp() = 0;
    virtual void UpdateInCombatAI_Hunter_Pvp() = 0;
    virtual void UpdateOutOfCombatAI_Hunter_Pvp() = 0;
    virtual void UpdateInCombatAI_Mage_Pvp() = 0;
    virtual void UpdateOutOfCombatAI_Mage_Pvp() = 0;
    virtual void UpdateInCombatAI_Priest_Pvp() = 0;
    virtual void UpdateOutOfCombatAI_Priest_Pvp() = 0;
    virtual void UpdateInCombatAI_Warlock_Pvp() = 0;
    virtual void UpdateOutOfCombatAI_Warlock_Pvp() = 0;
    virtual void UpdateInCombatAI_Warrior_Pvp() = 0;
    virtual void UpdateOutOfCombatAI_Warrior_Pvp() = 0;
    virtual void UpdateInCombatAI_Rogue_Pvp() = 0;
    virtual void UpdateOutOfCombatAI_Rogue_Pvp() = 0;
    virtual void UpdateInCombatAI_Druid_Pvp() = 0;
    virtual void UpdateOutOfCombatAI_Druid_Pvp() = 0;
