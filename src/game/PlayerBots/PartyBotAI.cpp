...
void PartyBotAI::UpdateOutOfCombatAI_Paladin_Pve()
{
...
void PartyBotAI::UpdateInCombatAI_Paladin_Pve()
{
...
void PartyBotAI::UpdateOutOfCombatAI_Shaman_Pve()
{
...
void PartyBotAI::UpdateInCombatAI_Shaman_Pve()
{
...
void PartyBotAI::UpdateOutOfCombatAI_Hunter_Pve()
{
...
void PartyBotAI::UpdateInCombatAI_Hunter_Pve()
{
    if (Unit* pVictim = me->GetVictim())
    {
        if (me->GetMotionMaster()->GetCurrentMovementGeneratorType() == IDLE_MOTION_TYPE
...
void PartyBotAI::UpdateOutOfCombatAI_Mage_Pve()
{
...
void PartyBotAI::UpdateInCombatAI_Mage_Pve()
{
    if (Unit* pVictim = me->GetVictim())
    {
...
void PartyBotAI::UpdateOutOfCombatAI_Priest_Pve()
{
...
void PartyBotAI::UpdateInCombatAI_Priest_Pve()
{
...
void PartyBotAI::UpdateOutOfCombatAI_Warlock_Pve()
{
...
void PartyBotAI::UpdateInCombatAI_Warlock_Pve()
{
    if (Unit* pVictim = me->GetVictim())
    {
...
void PartyBotAI::UpdateOutOfCombatAI_Warrior_Pve()
{
...
void PartyBotAI::UpdateInCombatAI_Warrior_Pve()
{
    if (Unit* pVictim = me->GetVictim())
    {
...
void PartyBotAI::UpdateOutOfCombatAI_Rogue_Pve()
{
...
void PartyBotAI::UpdateInCombatAI_Rogue_Pve()
{
    if (Unit* pVictim = me->GetVictim())
    {
...
void PartyBotAI::UpdateOutOfCombatAI_Druid_Pve()
{
...
void PartyBotAI::UpdateInCombatAI_Druid_Pve()
{
