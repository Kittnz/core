...
void WSG_AtAllianceFlag(CombatBotBaseAI* pAI)
{
...
void WSG_AtHordeFlag(CombatBotBaseAI* pAI)
{
...
void WSG_AtAllianceGraveyard(CombatBotBaseAI* pAI)
{
...
void WSG_AtHordeGraveyard(CombatBotBaseAI* pAI)
{
...
void AtFlag(CombatBotBaseAI* pAI, std::vector<uint32> const& vFlagIds)
{
...
void AB_AtFlag(CombatBotBaseAI* pAI)
{
    AtFlag(pAI, vFlagsAB);
}

void AV_AtFlag(CombatBotBaseAI* pAI)
{
    AtFlag(pAI, vFlagsAV);
}

void AtCaveExit(CombatBotBaseAI* pAI)
{
    pAI->me->StopMoving();
...
void MoveToNextPointSpecial(CombatBotBaseAI* pAI)
{
...
void CombatBotBaseAI::MovementInform(uint32 movementType, uint32 data)
{
...
void CombatBotBaseAI::MoveToNextPoint()
{
    if (!m_currentPath)
        return;
...
bool CombatBotBaseAI::StartNewPathFromBeginning()
{
...
void CombatBotBaseAI::StartNewPathFromAnywhere()
{
...
bool CombatBotBaseAI::StartNewPathToPosition(Position const& targetPosition, std::vector<BattleBotPath*> const& vPaths)
{
    BattleBotPath* pClosestPath = nullptr;
    uint32 closestPoint = 0;
...
bool CombatBotBaseAI::StartNewPathToObjective()
{
...
void CombatBotBaseAI::UpdateWaypointMovement()
{
...
void CombatBotBaseAI::DoGraveyardJump()
{
    BattleGround* bg = me->GetBattleGround();
...
void CombatBotBaseAI::ClearPath()
{
...
void CombatBotBaseAI::StopMoving()
{
    me->StopMoving();
