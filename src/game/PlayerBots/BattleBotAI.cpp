...
bool BattleBotAI::ShouldIgnoreCombat()
{
...
Unit* BattleBotAI::SelectAttackTarget(Unit* pExcept)
{
...
void BattleBotAI::UpdateOutOfCombatAI_Paladin_Pvp()
{
...
void BattleBotAI::UpdateInCombatAI_Paladin_Pvp()
{
...
void BattleBotAI::UpdateOutOfCombatAI_Shaman_Pvp()
{
...
void BattleBotAI::UpdateInCombatAI_Shaman_Pvp()
{
    if (m_spells.shaman.pGhostWolf &&
...
void BattleBotAI::UpdateOutOfCombatAI_Hunter_Pvp()
{
    if (m_spells.hunter.pAspectOfTheCheetah &&
       !me->IsMounted() &&
        CanTryToCastSpell(me, m_spells.hunter.pAspectOfTheCheetah))
...
void BattleBotAI::UpdateInCombatAI_Hunter_Pvp()
{
    if (Unit* pVictim = me->GetVictim())
    {
        if (me->GetMotionMaster()->GetCurrentMovementGeneratorType() == IDLE_MOTION_TYPE
...
void BattleBotAI::UpdateOutOfCombatAI_Mage_Pvp()
{
...
void BattleBotAI::UpdateInCombatAI_Mage_Pvp()
{
    if (Unit* pVictim = me->GetVictim())
    {
...
void BattleBotAI::UpdateOutOfCombatAI_Priest_Pvp()
{
    BattleGround* bg = me->GetBattleGround();
...
void BattleBotAI::UpdateInCombatAI_Priest_Pvp()
{
    if (m_spells.priest.pPowerWordShield &&
        CanTryToCastSpell(me, m_spells.priest.pPowerWordShield))
    {
...
void BattleBotAI::UpdateOutOfCombatAI_Warlock_Pvp()
{
    BattleGround* bg = me->GetBattleGround();
    if (bg && bg->GetStatus() == STATUS_WAIT_JOIN)
    {
...
void BattleBotAI::UpdateInCombatAI_Warlock_Pvp()
{
    if (Unit* pVictim = me->GetVictim())
    {
        if (m_spells.warlock.pDeathCoil &&
...
void BattleBotAI::UpdateOutOfCombatAI_Warrior_Pvp()
{
...
void BattleBotAI::UpdateInCombatAI_Warrior_Pvp()
{
    if (Unit* pVictim = me->GetVictim())
    {
...
void BattleBotAI::UpdateOutOfCombatAI_Rogue_Pvp()
{
...
void BattleBotAI::UpdateInCombatAI_Rogue_Pvp()
{
    if (Unit* pVictim = me->GetVictim())
    {
...
void BattleBotAI::UpdateOutOfCombatAI_Druid_Pvp()
{
    BattleGround* bg = me->GetBattleGround();
    if (bg && bg->GetStatus() == STATUS_WAIT_JOIN)
    {
...
void BattleBotAI::UpdateInCombatAI_Druid_Pvp()
{
    if (m_spells.druid.pTravelForm &&
