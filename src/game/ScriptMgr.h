...
struct Script
{
    Script() :
        ...
        pItemUse(nullptr), pItemUseSpell(nullptr), pEffectDummyCreature(nullptr), pEffectDummyGameObj(nullptr), pItemDestroy(nullptr),
...
class ScriptMgr
{
    public:
        ...
        bool OnItemDestroy(Player* pPlayer, Item* pItem);
