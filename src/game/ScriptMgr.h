...
enum ScriptTarget
{
    ...
    TARGET_T_CREATURE_WITH_ENTRY            = 8,            //Searches for closest creature with the given entry.
    ...
    TARGET_T_GAMEOBJECT_WITH_ENTRY          = 11,           //Searches for closest gameobject with the given entry.
