...
enum eConfigUInt32Values
{
    ...
    CONFIG_UINT32_WORLDBOT_HORDE_MAX,
    CONFIG_UINT32_WORLDBOT_ALLIANCE_MAX,
    CONFIG_UINT32_WORLDBOT_LEVEL_RANGE_1_MIN,
    CONFIG_UINT32_WORLDBOT_LEVEL_RANGE_1_MAX,
    CONFIG_UINT32_WORLDBOT_LEVEL_RANGE_2_MIN,
    CONFIG_UINT32_WORLDBOT_LEVEL_RANGE_2_MAX,
    CONFIG_UINT32_WORLDBOT_LEVEL_RANGE_3_MIN,
    CONFIG_UINT32_WORLDBOT_LEVEL_RANGE_3_MAX,
    CONFIG_UINT32_WORLDBOT_LEVEL_RANGE_4_MIN,
    CONFIG_UINT32_WORLDBOT_LEVEL_RANGE_4_MAX,
...
enum eConfigFloatValues
{
    ...
    CONFIG_FLOAT_WORLDBOT_LEVEL_RANGE_1_PERCENT,
    CONFIG_FLOAT_WORLDBOT_LEVEL_RANGE_2_PERCENT,
    CONFIG_FLOAT_WORLDBOT_LEVEL_RANGE_3_PERCENT,
    CONFIG_FLOAT_WORLDBOT_LEVEL_RANGE_4_PERCENT,
...
enum eConfigBoolValues
{
    ...
    CONFIG_BOOL_WORLDBOT,
    CONFIG_BOOL_WORLDBOT_LOADER,
    CONFIG_BOOL_WORLDBOT_USECHAT,
